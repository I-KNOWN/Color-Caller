...
public class Global {
    ...
    public static void showUpdateAppDialog(Activity activity, AppInterfaces.UpdateAppInterface updateAppInterface) {
        ...
        updateDialog.findViewById(R.id.tv_install).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                updateAppInterface.isUpdated(true);
        ...
        updateDialog.findViewById(R.id.tv_cancel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                updateAppInterface.isUpdated(false);
                updateDialog.dismiss();
                activity.finish();
                System.exit(0);
            }
    ...
    public static void showAlertProgressDialog(Activity activity) {
        if(activity.getComponentName().getClassName().equals("com.themecolor.callerphone.wallpaper.ui.SplashActivity")){
    ...
    public static View getDefaultImage(Context context, Drawable imgRes) {
        ...
        imageView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.CENTER));
    ...
    public static void setGradientShaderToTextView(TextView textView, String firstColor, String secondColor) {
        Paint paint = textView.getPaint();
        int[] colors = {Color.parseColor(firstColor), Color.parseColor(secondColor)};
    ...
    public static void setColorToTextView(TextView textView, String firstColor) {
        Paint paint = textView.getPaint();
        int[] colors = {Color.parseColor(firstColor)};
        float width = paint.measureText(textView.getText().toString());
        Shader textShader = new LinearGradient(0f, 1f, width, textView.getTextSize(), colors, null, Shader.TileMode.CLAMP);
        textView.getPaint().setShader(textShader);
    }
