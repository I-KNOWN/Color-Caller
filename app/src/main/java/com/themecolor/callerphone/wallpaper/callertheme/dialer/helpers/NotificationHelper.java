package com.themecolor.callerphone.wallpaper.callertheme.dialer.helpers;
...
import com.themecolor.callerphone.wallpaper.callertheme.dialer.CallingAnimActivity;
import com.themecolor.callerphone.wallpaper.callertheme.dialer.receivers.ActionReceiver;
...
public class NotificationHelper {
    ...
    public static void createIncomingNotification(Context context, Call call) {
        ...
        Intent incomingCallIntent = new Intent(context, CallingAnimActivity.class);
...
//    _____________________________________________________________________________________________________________
    ...
    public static void createIngoingCallNotification(Context context, Call call, String callDuration, String speakerBtnTxt, String muteBtnTxt) {
        ...
        Intent ingoingCallIntent = new Intent(context, CallingAnimActivity.class);
...
//    _____________________________________________________________________________________________________________
    ...
    public static void createOutgoingNotification(Context context, Call call) {
        ...
        Intent outingCallIntent = new Intent(context, CallingAnimActivity.class);
