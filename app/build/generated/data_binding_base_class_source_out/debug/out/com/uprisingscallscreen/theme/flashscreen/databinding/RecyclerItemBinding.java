...
public final class RecyclerItemBinding implements ViewBinding {
  ...
  private RecyclerItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView download,
      @NonNull ImageView gridImage) {
  ...
  public static RecyclerItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecyclerItemBinding((LinearLayout) rootView, download, gridImage);
    }
